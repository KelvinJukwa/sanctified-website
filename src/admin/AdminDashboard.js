...
function QuickLinks({ setActiveTab }) {
  ...
  const [counts, setCounts] = useState({ gallery: 0, videos: 0, events: 0, members: 0 });
  ...
  return (
    <div>
      ...
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', padding: '2rem 2.5rem', marginBottom: '2rem', borderLeft: '4px solid var(--gold)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <a href="/" target="_blank" rel="noopener noreferrer" style={{ padding: '0.75rem 1.75rem', border: '1px solid var(--gold)', color: 'var(--gold)', textDecoration: 'none', fontFamily: 'Cinzel, serif', fontSize: '0.65rem', letterSpacing: '0.2em', transition: 'all 0.3s' }}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '2.5rem' }}>
        {cards.map((card) => (
          <div key={card.tab} style={{ background: card.color, border: `1px solid ${card.border}`, padding: '1.5rem', textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
          {cards.map((card) => (
            ...
            >
              ...
              <div>
                <h3 style={{ fontFamily: 'Cinzel, serif', color: 'var(--text)', fontSize: '0.9rem', marginBottom: '4px', letterSpacing: '0.1em' }}>
                  {card.title}
                </h3>
  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '0.85rem', fontStyle: 'italic' }}>Invite new admins to manage the website</p>
      </div>
      ...
      <div style={{ background: 'var(--card)', border: '1px solid var(--border)', padding: '2rem', marginBottom: '2rem', borderTop: '3px solid var(--gold)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.75rem' }}>
          ...
          <span style={{ fontFamily: 'Cinzel, serif', fontSize: '0.62rem', letterSpacing: '0.35em', color: 'var(--gold)' }}>CREATE NEW ADMIN ACCOUNT</span>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="newadmin@sanctified.co.zw"
          ...
          <div>
            <label style={{ display: 'block', fontFamily: 'Cinzel, serif', fontSize: '0.6rem', letterSpacing: '0.2em', color: 'var(--muted)', marginBottom: '0.5rem' }}>TEMPORARY PASSWORD</label>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '0.8rem', fontStyle: 'italic', marginTop: '1rem' }}>
          💡 Share the email and password with the new admin. They can change their password after logging in.
        </p>
      </div>

      {/* Info Box */}
      <div style={{ padding: '1.5rem', background: 'rgba(201,168,76,0.05)', border: '1px solid rgba(201,168,76,0.2)' }}>
        <div style={{ fontFamily: 'Cinzel, serif', fontSize: '0.62rem', letterSpacing: '0.25em', color: 'var(--gold)', marginBottom: '0.75rem' }}>🔑 ADMIN LOGIN URL</div>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '0.82rem', fontStyle: 'italic', marginTop: '0.75rem' }}>
          Share this link with admins so they can access the portal.
        </p>
      </div>
    </div>
  );
